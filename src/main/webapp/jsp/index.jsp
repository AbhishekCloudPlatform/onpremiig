...
<body class="profile-page sidebar-collapse">
  ...
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('./material/img/city-profile.jpg');"></div>
        ...
        <div class="tab-content tab-space">
          <div class="tab-pane active text-center gallery" id="studio">
            <div class="row">
              ...
              <div class="col-md-4 ml-auto">
               <a href="#" > <img src="./material/img/examples/register.jpg" alt="Image" height="160" width="160" class="rounded">
								<h4>Register Feed</h4> </a>

              </div>
			   <div class="col-md-4 ml-auto">
               <a href="#" > <img src="./material/img/examples/dashboard.jpg" alt="Image" height="160" width="160"class="rounded">
         ...
         <!-- <div class="tab-pane text-center gallery" id="works">
            <div class="row">
              <div class="col-md-3 ml-auto">
                <img src="./material/img/examples/olu-eletu.jpg" class="rounded">
                <img src="./material/img/examples/clem-onojeghuo.jpg" class="rounded">
                <img src="./material/img/examples/cynthia-del-rio.jpg" class="rounded">
              </div>
              <div class="col-md-3 mr-auto">
                <img src="./material/img/examples/mariya-georgieva.jpg" class="rounded">
                <img src="./material/img/examples/clem-onojegaw.jpg" class="rounded">
              </div>
            </div>
          </div>
          <div class="tab-pane text-center gallery" id="favorite">
            <div class="row">
              <div class="col-md-3 ml-auto">
                <img src="./material/img/examples/mariya-georgieva.jpg" class="rounded">
                <img src="./material/img/examples/studio-3.jpg" class="rounded">
              </div>
              <div class="col-md-3 mr-auto">
                <img src="./material/img/examples/clem-onojeghuo.jpg" class="rounded">
                <img src="./material/img/examples/olu-eletu.jpg" class="rounded">
                <img src="./material/img/examples/studio-1.jpg" class="rounded">
              </div>
            </div>
          </div>-->
        </div>
